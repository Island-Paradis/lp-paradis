# navbar-link-destinations Specification

## Purpose

Os destinos do navbar — os botões do CMS passarem a navegar, o prefixo de locale nos links e nos botões, quais `href` são deixados intactos, e a visibilidade em mobile.
