# responsive-content-fit Specification

## Purpose

Garante que nenhum conteúdo da home seja cortado, truncado ou renderizado fora da sua superfície visível em qualquer largura de viewport — cobre truncamento de rótulos, caps de medida de leitura, e espaçamento/tipografia que não deixam área útil suficiente.

_Introduzida por `fix-responsive-content-clipping`, sincronizada ao arquivar._
