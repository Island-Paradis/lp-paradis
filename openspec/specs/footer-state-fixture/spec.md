# footer-state-fixture Specification

## Purpose

Uma superfície de desenvolvimento que renderiza o footer em estados de conteúdo escolhidos em código, sem banco, e que é inalcançável em produção. Cobre o que a rota mostra, como os estados são rotulados, e — o requisito com risco real — a garantia de que ela não existe no site publicado.

_Introduzida por `verify-footer-edge-cases`, sincronizada ao arquivar._
